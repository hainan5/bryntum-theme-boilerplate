...
import { DomHelper } from "@bryntum/gantt/gantt.umd.js";

const GanntComp2 = (props) => {
    ...
    taskRenderer({ taskRecord, renderData }) {
      return [
        ...
        ...taskRecord.resources.map((resource) => ({
          tag: "span",
          style:
            "display:inline-block;font-size:0.8em;padding:0.4em;background:rgba(0,0,0,0.1);border-radius:50%;margin-right:0.3em",
  ...
  return (
    <div>
      <BryntumGantt ref={ref} {...ganttConfig} />
    </div>
  );
};

export default GanntComp2;
